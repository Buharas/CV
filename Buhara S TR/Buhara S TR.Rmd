...
tribble(
  ...
  "Menkul Kıymetler ve Sermaye Piyasaları", "2023-Devam Ediyor", "Anadolu Üniversitesi", "Eskişehir, Türkiye",
...
tribble(
  ~Kurum, ~Year, ~Kısaltma,
  "FEN VE MÜHENDİSLİK FAKÜLTELERİ TİYATRO ÖĞRENCİ TOPLULUĞU", "2019", "AFTİF"
) %>%
  detailed_entries(Kurum, Year, Kısaltma)
